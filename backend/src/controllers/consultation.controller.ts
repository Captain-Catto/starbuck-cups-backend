...
export class ConsultationController {
  ...
  getConsultationById = async (req: Request, res: Response) => {
    try {
      ...
      const consultation =
        await this.consultationService.getConsultationById(id);
  ...
  updateConsultationStatus = async (req: Request, res: Response) => {
    try {
      const { id } = req.params;
  ...
  getPendingConsultationsCount = async (req: Request, res: Response) => {
    try {
      const count =
        await this.consultationService.getPendingConsultationsCount();
